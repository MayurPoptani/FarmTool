...
class RentToolPageController extends BaseController<RentToolsDoc> {

  String? docId;

  RentToolPageController([RentToolsDoc? item]) {
    if(item!=null) {
      docId = item.id;
